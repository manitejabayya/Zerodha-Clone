  ...
  return (
    ...
    <div className="container border-top mt-5">
      <div className="row mt-5">
        <div className="col">
          <img src="/assests/logo.svg" style={{ width: "50%" }} alt="Stock Trading logo" />
          <p>© 2010-2025, Not Zerodha Broking Ltd. All rights reserved.</p>
        </div>
        <div className="col">
          <p>Company</p>
          <a href="/">About</a> <br />
      ...
      <div className="mt-5 text-muted" style={{fontSize:"14"}}>
        <p>
